...
volatile unsigned char disp_buff[131][131];
volatile unsigned char text_buff[60][127];
//volatile unsigned char nums_buff[30][150];
...
const char *var_menu[6] = {"Cadence","Distance","Pushes","Speed","Options","Debug"};
volatile char *val_disp[6] = {"56","2.0","50","3.0","  ","  "};
const char *time_scale[4][4] ={{"0","6a","12","6p"},{"0","M","W","F"},{"1-6","8-6","16-6","24-6"},{"Jan","Apr","Jul","Oct"}}; 
const char time_divisions[4] = {24,42,32,52};

const char _row1 = 3;
const char _row2 = 3+11+TEXT_SPACING;
const char _row3 = 3+2*(11+TEXT_SPACING);
const char _row4 = 3+3*(11+TEXT_SPACING);
volatile char _current_row = 0;

unsigned int var_selection = 2;
unsigned int time_selection = 0;
